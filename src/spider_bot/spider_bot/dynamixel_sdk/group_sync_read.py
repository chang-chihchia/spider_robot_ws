...
class GroupSyncRead:
    ...
    def getData(self, dxl_id, address, data_length):
        ...
        if data_length == 1:
            ...
            ## In case of SyncRead Current 2bytes / Velocity 4bytes / Position 4bytes
            data1 = DXL_MAKEWORD(self.data_dict[dxl_id][address - self.start_address],
                                self.data_dict[dxl_id][address - self.start_address + 1])

            data2 = DXL_MAKEDWORD(DXL_MAKEWORD(self.data_dict[dxl_id][address - self.start_address + 2],
                                              self.data_dict[dxl_id][address - self.start_address + 3]),
                                DXL_MAKEWORD(self.data_dict[dxl_id][address - self.start_address + 4],
                                              self.data_dict[dxl_id][address - self.start_address + 5]))

            data3 = DXL_MAKEDWORD(DXL_MAKEWORD(self.data_dict[dxl_id][address - self.start_address + 6],
                                              self.data_dict[dxl_id][address - self.start_address + 7]),
                                DXL_MAKEWORD(self.data_dict[dxl_id][address - self.start_address + 8],
                                              self.data_dict[dxl_id][address - self.start_address + 9]))
